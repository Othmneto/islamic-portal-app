...
router.get('/callback', async (req, res) => {
  ...
  try {
    ...
    console.log('✅ Microsoft OAuth: Refresh token received:', refresh_token ? 'YES' : 'NO');
    console.log('✅ Microsoft OAuth: Expires in:', expires_in, 'seconds');
    ...
    // Save Microsoft OAuth tokens for calendar integration
    console.log('🔄 Microsoft OAuth: Saving OAuth tokens for calendar integration');
    ...
    console.log('✅ Microsoft OAuth: OAuth tokens saved successfully:', {
    ...
    jwt.sign(
      payload,
      env.JWT_SECRET,
      // No expiry for persistent authentication
      (err, token) => {
        if (err) {
